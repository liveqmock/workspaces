...
public class App {
	public static void main(String[] args) {
		...
		interpreter.execfile("/Users/jjwu/Desktop/fibo.py ");
		PyFunction func = interpreter.get("main", PyFunction.class);
		PyObject result = func.__call__();
		System.out.print("JavaConsole-Result:" + result.asString());

		// PythonInterpreter interpreter = new PythonInterpreter();
		// interpreter.execfile("/Users/jjwu/Documents/workspaces/simulator/xjython/src/main/java/com/iwgame/jython/test2.py");
		// PyFunction func = interpreter.get("main", PyFunction.class);
		// func.__call__();
