 ...
 */
@GinModules(value = { XMVPAppGinContainer.class, LandingGinContainer.class })
public interface LandingModuleInject extends XMVPModuleInject {

	@Override
	LandingModule getModule();
}
