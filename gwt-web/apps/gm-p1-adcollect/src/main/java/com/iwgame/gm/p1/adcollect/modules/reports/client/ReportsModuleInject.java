 ...
 */
@GinModules(value = { XMVPAppGinContainer.class, ReportsGinContainer.class })
public interface ReportsModuleInject extends XMVPModuleInject {

	@Override
	ReportsModule getModule();
}
