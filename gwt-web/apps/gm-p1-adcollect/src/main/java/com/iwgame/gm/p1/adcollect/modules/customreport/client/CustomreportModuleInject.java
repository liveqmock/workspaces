 ...
 */
@GinModules(value = { XMVPAppGinContainer.class, CustomreportGinContainer.class })
public interface CustomreportModuleInject extends XMVPModuleInject {

	@Override
	CustomreportModule getModule();
}
