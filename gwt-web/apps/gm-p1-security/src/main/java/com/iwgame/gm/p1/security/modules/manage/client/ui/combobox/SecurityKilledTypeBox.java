...
public class SecurityKilledTypeBox extends ComboBoxField {
	 ...
	 * @param label
	 */
	public SecurityKilledTypeBox(String label) {
		super(label);
		this.initBoxData(defaultHeadCaption);
	}
	
	public SecurityKilledTypeBox(String label,String fieldName) {
	 ...
	 * 								  true 添加  false 不添加
	 */
	public SecurityKilledTypeBox(String label,boolean isAddDefaultHeadCaption) {
		super(label);
