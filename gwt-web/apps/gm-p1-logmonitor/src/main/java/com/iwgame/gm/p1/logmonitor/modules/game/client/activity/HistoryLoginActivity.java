 ...
 * 
 */
public class HistoryLoginActivity extends AbstractActivity implements SchemaGridViewPresenter {

	private final HistoryLoginView view;

	/**
	 * 
	 */
	public HistoryLoginActivity(final HistoryLoginView view) {
		super();
		this.view = view;
	}
	...
	public void loadData(final Object loadConfig, final AsyncCallbackEx<String> callback) {
		...
		LoginService.Util.get()
				.getHistoryLoginDatas(ApplicationContext.getCurrentProduct().getName(), config, callback);
	}
