		...
		<div class="main content clearfix">
			<div class="sign-in">
				<div class="signin-box">
					...
					<form id="loginform" method="post" action="passpod">
						<label> <strong class="email-label">用户名</strong> <input
							id="username" type="text" value="" name="username"
							spellcheck="false" />
						</label> <label> <strong class="passwd-label">密保序号</strong> <input
							id="passpodsn" type="text" name="passpodsn" value=""/>
						</label><label> <strong class="passpod-label">动态密码</strong> <input
							id="passpod" type="password" name="passpod"  value=""/>
						</label><input id="signIn" class="g-button g-button-submit" type="submit"
							value="校准" name="signIn" />
						<div>
			...
			<div class="product-info mail">
				...
				<ul class="features">
					<li><img alt=""
						...
						<p class="title">用户名为登录OA系统的用户名</p>
						<p>&nbsp;</p></li>
					<li><img alt=""
						src="//ssl.gstatic.com/images/icons/feature/filing_cabinet-g42.png">
						<p class="title">密保序号为硬件密保背面的SN（共7位数字）</p>
						<p>&nbsp;</p></li>
					<li><img alt=""
						src="//ssl.gstatic.com/images/icons/feature/filing_cabinet-g42.png">
						<p class="title">如果看不到，请长按密保按钮，密码框会显示序号</p>
						<p>&nbsp;</p></li>
				</ul>
			</div>
		</div>
