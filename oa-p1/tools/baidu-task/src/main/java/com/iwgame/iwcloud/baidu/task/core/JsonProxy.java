...
public class JsonProxy<I> implements InvocationHandler {
	 ...
	 * 
	 * @param <T>
	 *            The proxy instannce type.
	 * @param interfaces
	 *            The proxy instannce type class.
	 * @param service
	 *            The original object.
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
		JsonConnection conn = new GZIPJsonConnection(service.getFetcherConfig().getServerUrl() + "/json/sms/v2/" + interfaces.getSimpleName() + '/' + method.getName());
		conn.setConnectTimeout(service.getFetcherConfig().getConnectTimeoutMills());
		conn.setReadTimeout(service.getFetcherConfig().getReadTimeoutMills());
