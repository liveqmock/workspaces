 ...
 ****************************************************************/
package com.iwgame.xengine.xtask.guild;
...
import com.iwgame.xengine.xtask.guild.util.Version;
...
public class TaskStartup {
	...
	public static void main(final String[] args) {
		...
		try {
			...
			logger.info("[XTASK-GUILD]-缓存当前开启的公会赛信息");
			contextService.loadCurrentRace();

			if (Context.get().hasOpenRace()) {
				logger.info("[XTASK-GUILD]-缓存参赛用户列表");
			...
			logger.info("[XTASK-GUILD]-消息任务系统启动...");
