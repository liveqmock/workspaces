...
import com.iwgame.account.kill.modules.logs.client.activity.AutoLogsListActivity;
 ...
 */
public class LogsActivityMapper extends AbstractModuleActivityMapper {
	protected PlaceController placeController;
	protected EventBus eventBus;

	@Inject
	public LogsActivityMapper(final PlaceController placeController, final EventBus eventBus) {
		super();
	...
	protected Activity onGetActivity(final String action, final String[] params,
		...
		if (action.equals("auto")){
			return new AutoLogsListActivity(new AutoLogsListViewImpl());
		}
