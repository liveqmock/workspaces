 ...
 */
@GinModules(value = { XMVPAppGinContainer.class, AccountGinContainer.class })
public interface AccountModuleInject extends XMVPModuleInject {

	@Override
	AccountModule getModule();
}
