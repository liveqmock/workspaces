...
import com.iwgame.gm.p1.adcollect.modules.baidu.account.client.activity.AccountMgrActivity;
 ...
 */
public class AccountActivityMapper extends AbstractModuleActivityMapper {
	protected PlaceController placeController;
	protected EventBus eventBus;

	@Inject
	public AccountActivityMapper(final PlaceController placeController, final EventBus eventBus) {
		super();
	...
	protected Activity onGetActivity(final String action, final String[] params, final Map<String, String> queryParams) {
		if ("baidu".equals(action)) {
			return new AccountMgrActivity(new AccountMgrView());
		}
