 ...
 */
@ReportSelector("position")
public class ReportPositionField extends Field<String, ReportPositionSelector> {

	public ReportPositionField(final String label) {
		super(label, new ReportPositionSelector());
	}
