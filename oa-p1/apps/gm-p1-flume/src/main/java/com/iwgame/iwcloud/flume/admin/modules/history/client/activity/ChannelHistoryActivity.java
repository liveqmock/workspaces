 ...
 * 
 */
public class ChannelHistoryActivity extends AbstractActivity implements SchemaGridViewPresenter {

	private final ChannelHistoryView view;
	 ...
	 *            查询参数
	 */
	public ChannelHistoryActivity(final ChannelHistoryView view, final Map<String, String> queryParams) {
		super();
		this.view = view;
	...
	public void start(final AcceptsOneWidget panel, final EventBus eventBus) {
		view.setSchemaJson("{\"table\":{\"key\":\"channelId\",\"columns\":["
				+ "{\"index\":\"channelId\",\"header\":\"通道Id\",\"width\":150},"
				+ "{\"index\":\"fetcherCount\",\"header\":\"采集汇总（条）\",\"width\":200,\"type\":\"number\"},"
				...
				+ "{\"index\":\"sinkCount\",\"header\":\"存储汇总（条）\",\"width\":200,\"type\":\"number\"},"
				...
				+ "{\"index\":\"costtime\",\"header\":\"入库累计耗时（秒）\",\"width\":200,\"type\":\"number\",\"visiable\":false},"
				+ "{\"index\":\"sinkv\",\"header\":\"入库速率(条/秒)\",\"width\":100,\"type\":\"number\",\"visiable\":false},"
	...
	public void loadData(final Object loadConfig, final AsyncCallbackEx<String> callback) {
		HistoryService.Util.get().getChannelDatas(ApplicationContext.getCurrentProduct().getName(), channelId, date,
				callback);
