...
public class ChannelTodayView extends IntervalSchemaGridView {
	...
	public ChannelTodayView() {
					...
					public void execute(final BaseModelData rowData) {
						new TimeDataDialog() {
							...
							public void loadData(final Object loadConfig, final AsyncCallbackEx<String> callback) {
								DatasService.Util.get().getChannelTimeDatas(rowData.<String> get("channelId"), date,
										callback);
							}
		...
		// int s = Integer.valueOf(selector.getValue());
		// intervalLoad(s);
		// Cookies.setCookie("com.iwgame.flume.monitor.interval",
		// selector.getValue());
		// }
		// });
		// layout.add(selector);
		...
		btnBack.addClickHandler(new ClickHandler() {
			...
			@Override
			public void onClick(final ClickEvent event) {
				History.newItem("flumeadmin/datas/integrity?action=m&date="
