 ...
 * @版本： 1.0
 */
@GinModules(value = { XMVPAppGinContainer.class, BusinessGinContainer.class })
public interface BusinessModuleInject extends XMVPModuleInject {
	
	BusinessModule getModule();
}
