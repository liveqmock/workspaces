/****************************************************************
 *  系统名称  ： '[finance]'
 *  文件名    ： CheckBillActivityMapper.java
 ...
 * @版本： 1.0
 */
public class CheckBillActivityMapper extends AbstractModuleActivityMapper {
	protected PlaceController placeController;
	protected EventBus eventBus;

	@Inject
	public CheckBillActivityMapper(final PlaceController placeController, final EventBus eventBus) {
		super();
