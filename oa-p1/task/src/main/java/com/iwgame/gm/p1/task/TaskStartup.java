 ...
 ****************************************************************/
package com.iwgame.gm.p1.task;

import org.apache.log4j.Logger;
import org.apache.log4j.PropertyConfigurator;

import com.iwgame.gm.p1.task.spring.ApplicationContextHelper;
import com.iwgame.gm.p1.task.util.Constant;
import com.iwgame.gm.p1.task.util.Version;
...
public class TaskStartup {
	static Logger logger = Logger.getLogger(Constant.LOG_XPORTAL_TASK);
