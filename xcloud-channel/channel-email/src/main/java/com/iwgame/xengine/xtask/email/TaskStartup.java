 ...
 ****************************************************************/
package com.iwgame.xengine.xtask.email;

import org.apache.log4j.Logger;
import org.apache.log4j.PropertyConfigurator;

import com.iwgame.xengine.xtask.core.spring.ApplicationContextHelper;
import com.iwgame.xengine.xtask.email.tools.version.Version;
...
public class TaskStartup {
	...
	public static void main(String[] args) {
		...
		try {
			...
			logger.info("[XTASK-EMAIL]-(邮件)消息任务系统启动...");
	...
	private static void printMQConnectionInfo() {
		ConnectionFactory connectionFactor = (ConnectionFactory) ApplicationContextHelper.getApplicationContext().getBean("rabbitMailMQSource");
		logger.info(connectionFactor.getClientProperties().toString());
		logger.info("[Host]:" + connectionFactor.getHost() + " [Port]:" + connectionFactor.getPort() + " [VirtualHost]:" + connectionFactor.getVirtualHost());
	}
}
