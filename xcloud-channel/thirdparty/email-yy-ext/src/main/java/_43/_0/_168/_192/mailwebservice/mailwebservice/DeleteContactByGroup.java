 ...
 *         &lt;element name="emails" type="{http://192.168.0.43/MailWebService/MailWebService.asmx}ArrayOfString" minOccurs="0"/>
...
@XmlRootElement(name = "DeleteContactByGroup")
public class DeleteContactByGroup {
