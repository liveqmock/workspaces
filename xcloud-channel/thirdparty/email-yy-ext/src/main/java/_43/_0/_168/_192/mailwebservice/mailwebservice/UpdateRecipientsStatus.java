 ...
 *         &lt;element name="recipients" type="{http://192.168.0.43/MailWebService/MailWebService.asmx}ArrayOfString" minOccurs="0"/>
...
@XmlRootElement(name = "UpdateRecipientsStatus")
public class UpdateRecipientsStatus {

    @XmlElement(required = true)
    protected EaseyeUserAccountDTO easeyeUserAccountDTO;
    protected ArrayOfString recipients;
     ...
     *     
     */
    public ArrayOfString getRecipients() {
        return recipients;
    }
     ...
     *     
     */
    public void setRecipients(ArrayOfString value) {
