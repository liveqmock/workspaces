...
public class SmsSendServiceImpl implements SmsSendService {
	...
	/* (non-Javadoc)
	 * @see com.iwgame.xcloud.searcher.service.SmsSendService#getHttpRequest(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
	 */
	@Override
	public String getHttpRequest(final HttpServletRequest request, final HttpServletResponse httpServletResponse) {
		return null;
	}
}