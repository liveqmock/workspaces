 ...
 * @修改时间：2012-5-10 下午5:03:46
 */
public class RewardGemstone {
	...
	public RewardGemstone(String jsonString) {
		...
		try {
			...
			if (content != null) {
				...
				for (int i = 0; i < jsonArray.size(); i++) {
					...
					stringBuilder.append("宝石名：").append(getJsonString(jObject, "name")).append(",");
