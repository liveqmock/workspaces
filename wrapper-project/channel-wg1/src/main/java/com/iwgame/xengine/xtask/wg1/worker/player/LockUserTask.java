 ...
 * @修改时间：2012-2-15 上午09:26:05
 */
public class LockUserTask extends AbstractMQWorker {
	private Logger logger = Logger.getLogger(LockUserTask.class);
	...
	public void handleMessage(String text) {
		logger.info("收到封禁玩家角色请求: " + text);

		String memoString = "封禁玩家角色操作";
		...
		logger.info("本次封禁玩家角色完成! text:" + text);
	}
}